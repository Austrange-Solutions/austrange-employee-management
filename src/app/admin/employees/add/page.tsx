...
import { createEmployeeSchema, CreateEmployeeFormData } from "@/schema/createEmployeeSchema";
...
export default function AddEmployee() {
  ...
  const onSubmit = async (data: CreateEmployeeFormData) => {
    ...
    const tempPassword = `${data.firstName.toLowerCase()}@123`;
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" min="18" max="100" placeholder="Auto-calculated" disabled {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Auto-populated" readOnly className="bg-gray-50" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={(value) => handleLevelChange(value)} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger>
